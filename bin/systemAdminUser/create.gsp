...
<body>
<a href="#create-systemAdminUser" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="create-systemAdminUser" class="content scaffold-create" role="main">
