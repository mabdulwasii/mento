...
<body>
<a href="#show-subject" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="show-subject" class="content scaffold-show" role="main">
    ...
    <g:form resource="${this.subject}" method="DELETE">
        <fieldset class="buttons">
            <g:link class="edit" action="edit" resource="${this.subject}"><g:message code="default.button.edit.label"
                                                                                     default="Edit"/></g:link>
