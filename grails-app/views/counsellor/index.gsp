...
<main>
    <div class="row">
        <div class=" page-topic white teal-text">
            <h5 class="center">Counsellor Profile</h5>
        </div>

        <div class="card col m9 z-depth-1-half hide-on-small-and-down">
            <div class="container">
                    ...
                    <div id="profile-page-header" class="card">
                        ...
                        <div class="card-reveal">
                            <p>
                                ...
                                <span><i class="mdi-action-perm-identity cyan-text text-darken-2"></i> Project Manager
                                </span>
                            </p>
                        ...
                        <div id="profile-page-sidebar" class="col s12 m4">
                            ...
                            <ul id="profile-page-about-details" class="collection z-depth-1">
                                <li class="collection-item">
                                    <div class="row">
                                        <div class="col s5 grey-text darken-1"><i
                                                class="mdi-action-wallet-travel"></i> Project</div>
                                ...
                                <li class="collection-item">
                                    <div class="row">
                                        <div class="col s5 grey-text darken-1"><i class="mdi-social-poll"></i> Skills
                                        </div>
                                ...
                                <li class="collection-item">
                                    <div class="row">
                                        <div class="col s5 grey-text darken-1"><i
                                                class="mdi-social-domain"></i> Lives in</div>
                                ...
                                <li class="collection-item">
                                    <div class="row">
                                        <div class="col s5 grey-text darken-1"><i
                                                class="mdi-social-cake"></i> Birth date</div>
                            ...
                            <ul id="profile-page-about-feed" class="collection z-depth-1">
                                <li class="collection-item avatar">
                                    ...
                                    <a href="user-profile-page.htm#!" class="secondary-content"><i
                                ...
                                <li class="collection-item avatar">
                                    ...
                                    <a href="user-profile-page.htm#!" class="secondary-content"><i
                                            class="mdi-editor-attach-money"></i></a>
                                </li>
                                <li class="collection-item avatar">
                                    ...
                                    <a href="user-profile-page.htm#!" class="secondary-content"><i
                                            class="mdi-action-track-changes"></i></a>
                                </li>
                            </ul>
                            <!-- Profile feed  -->
                            ...
                            <ul id="task-card" class="collection with-header">
                                ...
                                <li class="collection-item dismissable">
                                    ...
                                    <label for="task1">Create Mobile App UI. <a href="user-profile-page.htm#"
                                ...
                                <li class="collection-item dismissable">
                                    ...
                                    <label for="task2">Check the new API standerds. <a href="user-profile-page.htm#"
                                                                                       class="secondary-content"><span
                                ...
                                <li class="collection-item dismissable">
                                    ...
                                    <label for="task3">Check the new Mockup of ABC. <a href="user-profile-page.htm#"
                                                                                       class="secondary-content"><span
                            ...
                            <div class="card center-align">
                                <div class="card-content purple white-text">
                                    ...
                                    <p class="card-stats-compare"><i
                                            class="mdi-hardware-keyboard-arrow-up"></i> 70% <span
                                        ...
                                        <div class="row">
                                            <div class="col s6 m6 l6 center-align">
                                                <div class="flight-info">
                                                    <p class="small"><span
                                                            class="grey-text text-lighten-4">Depart:</span> 04.50</p>

                                                    <p class="small"><span
                                                            class="grey-text text-lighten-4">Flight:</span> IB 5786</p>
                                            ...
                                            <div class="col s6 m6 l6 center-align flight-state-two">
                                                <div class="flight-info">
                                                    <p class="small"><span
                                                            class="grey-text text-lighten-4">Arrive:</span> 08.50</p>
                            ...
                            <div class="map-card">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <h4 class="card-title grey-text text-darken-4"><a href="user-profile-page.htm#"
                                    ...
                                    <div class="card-reveal">
                                        ...
                                        <p><i class="mdi-communication-business cyan-text text-darken-2"></i> 125, ABC Street, New Yourk, USA
                                        </p>

                                        <p><i class="mdi-action-perm-phone-msg cyan-text text-darken-2"></i> +1 (612) 222 8989
                                        </p>

                                        <p><i class="mdi-communication-email cyan-text text-darken-2"></i> support@geekslabs.com
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col s12">
                                    <ul class="tabs tab-profile z-depth-1 light-blue">
                                        <li class="tab col s3"><a class="white-text waves-effect waves-light active"
                                                                  href="user-profile-page.htm#UpdateStatus"><i
                                                    class="mdi-editor-border-color"></i> Update Status</a>
                                        </li>
                                        <li class="tab col s3"><a class="white-text waves-effect waves-light"
                                                                  href="user-profile-page.htm#AddPhotos"><i
                                                    class="mdi-image-camera-alt"></i> Add Photos</a>
                                        </li>
                                        <li class="tab col s3"><a class="white-text waves-effect waves-light"
                                                                  href="user-profile-page.htm#CreateAlbum"><i
                                    ...
                                    <div id="UpdateStatus" class="tab-content col s12  grey lighten-4">
                                        ...
                                        <div class="row">
                                            <div class="col s12 m6 share-icons">
                                                <a href="user-profile-page.htm#"><i class="mdi-image-camera-alt"></i>
                                                </a>
                                                <a href="user-profile-page.htm#"><i
                                                        class="mdi-action-account-circle"></i></a>
                                                <a href="user-profile-page.htm#"><i
                                                        class="mdi-hardware-keyboard-alt"></i></a>
                                                <a href="user-profile-page.htm#"><i
                                                        class="mdi-communication-location-on"></i></a>
                                            </div>

                                            <div class="col s12 m6 right-align">
                                                <!-- Dropdown Trigger -->
                                                <a class='dropdown-button btn' href='user-profile-page.htm#'
                                                   data-activates='profliePost'><i
                                                        class="mdi-action-language"></i> Public</a>

                                                <!-- Dropdown Structure -->
                                                <ul id='profliePost' class='dropdown-content'>
                                                    <li><a href="user-profile-page.htm#!"><i
                                                            class="mdi-action-language"></i> Public</a></li>
                                                    <li><a href="user-profile-page.htm#!"><i
                                                            class="mdi-action-face-unlock"></i> Friends</a></li>
                                                    <li><a href="user-profile-page.htm#!"><i
                                                            class="mdi-action-lock-outline"></i> Only Me</a></li>
                                                </ul>
                                ...
                                <div class="col s12">
                                    ...
                                    <div id="profile-page-wall-post" class="card">
                                        <div class="card-profile-title">
                                            ...
                                            <div class="row">
                                                <div class="col s12">
                                                    <p>I am a very simple wall post. I am good at containing <a
                                                            href="user-profile-page.htm#">#small</a> bits of <a
                                                            href="user-profile-page.htm#">#information</a>.  I require little more information to use effectively.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-action row">
                                            <div class="col s4 card-action-share">
                                                <a href="user-profile-page.htm#">Like</a>
                                                <a href="user-profile-page.htm#">Share</a>
                                            </div>
                                        ...
                                        <div class="card-image profile-medium">
                                            <div class="video-container no-controls">
                                                <iframe width="640" height="360"
                                                        src="https://www.youtube.com/embed/10r9ozshGVE" frameborder="0"
                                    ...
                                    <div id="profile-page-wall-post" class="card">
                                        ...
                                        <div class="card-image profile-small">
                                            <img src="images/gallary/1.jpg" alt="sample"
    ...
    <div class="col m3 s12 card grey lighten-5">
        <div class="row">
            <ul class="collection">
                ...
                <h5 class="center collection-header teal-text">Recently Contacted</h5>

                <div class="divider"></div>

                <li class="collection-item"><a href="#">Adewale Smith</a></li>
...
<div id="profile" class="modal">
    <div class="modal-content center">
        ...
        <div id="profile-page-header" class="card">
            <div class="card-image waves-effect waves-block waves-light">
                <asset:image class="activator" src="image/user-profile-bg.jpg" alt="user background"/>
            </div>
            <figure class="card-profile-image">
                <asset:image src="image/avatar.jpg" alt="profile image"
                             class="circle z-depth-2 responsive-img activator"/>
            </figure>
            ...
            <div id="profile-page-sidebar" class="col s12 m4">
                ...
                <ul id="profile-page-about-feed" class="collection z-depth-1">
                    <li class="collection-item avatar">
                        ...
                        <a href="user-profile-page.htm#!" class="secondary-content"><i class="mdi-action-grade"></i></a>
                    </li>
                    <li class="collection-item avatar">
                        <i class="mdi-file-folder circle"></i>
                        <span class="title">New Project</span>
                        ...
                        <a href="user-profile-page.htm#!" class="secondary-content"><i class="mdi-social-domain"></i>
                        </a>
                    </li>
                    <li class="collection-item avatar">
                        <i class="mdi-action-assessment circle green"></i>
